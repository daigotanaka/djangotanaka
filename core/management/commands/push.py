...
class Command(BaseCommand):
    ...
    def push(self, username, api_key, slug, body, title, status="private"):
        params = {
            "username": username,
            "api_key": api_key,
        }
        ...
        response = requests.post(API_URL + "/page/", headers=headers, params=params, data=simplejson.dumps(data))
        print response
